...
1. NEVER change any metrics or numbers in the original text. Examples of critical metrics to preserve exactly:
   - "~100% performance improvement" 
   - "30% faster"
   - "significantly improving readability"
2. DO NOT change any job titles, company names, dates, or education details.
3. Use stronger action verbs but preserve the exact technology, project, and achievement context.
4. When you see existing achievements with specific metrics, keep them EXACTLY THE SAME.

For example, if you see:
"Optimized system performance by implementing multi-threading, achieving a ~100% performance improvement"

You might enhance it to:
"Dramatically optimized system performance by implementing multi-threading technology, achieving a ~100% performance improvement"

But NEVER to something that changes the technology or context like:
"Revolutionized user experience with PID-driven algorithm improving predictability by ~100%"
...
5. PAY SPECIAL ATTENTION to preserving approximate percentages like "~100%" - these must remain exactly as written
"""
